...
J.qQ(this.a.a,z.I8(a),z.I8(b))},"call$2",null,4,0,null,24,137,"call"],
$isEH:true},
Tf:{
"^":"HU;",
Pq:function(a){return a},
...
return new H.Zr(a.replace('\\$arguments\\$','((?:x|[^x])*)').replace('\\$argumentsExpr\\$','((?:x|[^x])*)').replace('\\$expr\\$','((?:x|[^x])*)').replace('\\$method\\$','((?:x|[^x])*)').replace('\\$receiver\\$','((?:x|[^x])*)'),y,x,w,v,u)},"call$1","uN",2,0,null,13],S7:[function(a){return function($expr$) {
...
z.toString
P.L2(z,null,z,a,b)},function(a){return P.SZ(a,null)},null,"call$2","call$1","AY",2,2,102,58,103,104],
...
L2:[function(a,b,c,d,e){P.T8(a,null,a,new P.pK(d,e))},"call$5","xP",10,0,null,111,112,96,103,104],
T8:[function(a,b,c,d){var z,y
if($.X3===c)return d.call$0()
z=P.PJ(c)
try{y=d.call$0()
return y}finally{$.X3=z}},"call$4","AI",8,0,null,111,112,96,78],
yv:[function(a,b,c,d,e){var z,y
if($.X3===c)return d.call$1(e)
z=P.PJ(c)
try{y=d.call$1(e)
return y}finally{$.X3=z}},"call$5","zq",10,0,null,111,112,96,78,113],
...
xL:[function(a,b){this.V8(a,b)},"call$2","gRE",4,0,148,103,104],
TE:[function(){this.Ig()},"call$0","gH1",0,0,99],
...
y=new W.JQ(y)
y.U5(a)
return y},qD:[function(a,b,c,d){return!0},"call$4","y3",8,0,126,127,128,19,68],QW:[function(a,b,c,d){var z,y,x,w,v,u
z=d.gKs()
y=z.on
x=J.RE(y)
x.sLU(y,c)
...
return z},"call$4","tc",8,0,126,127,128,19,68]}},
Pb:{
"^":"a;",
...
if(b===!0){z=[c]
C.Nm.FV(z,d)
d=z}return P.wY(H.Ek(a,P.F(J.C0(d,P.Xl()),!0,null),P.Te(null)))},"call$4","qH",8,0,null,100,129,111,64],
...
x=z.bind.apply(z,y)
String(x)
return P.ND(new x())},kW:function(a){if(typeof a==="number"||typeof a==="string"||typeof a==="boolean"||a==null)throw H.b(new P.AT("object cannot be a num, string, bool, or null"))
...
P.uw(J.UQ($.LX(),"MozActivity"),[z])},"call$1",null,2,0,null,10,"call"],
$isEH:true},
Or:{
"^":"Tp:132;",
...
P.kW(a).K9("toBlob",[new S.kJ()])}else window.alert("Image failed to load, can't be shared")},"call$1",null,2,0,null,10,"call"],
$isEH:true},
kJ:{
"^":"Tp:159;",
...
P.uw(J.UQ($.LX(),"MozActivity"),[z])},"call$1",null,2,0,null,158,"call"],
$isEH:true},
emv:{
"^":"Tp:132;",
...
P.uw(J.UQ(z,"Notification"),["See this",y])}}else J.UQ(J.UQ(z,"navigator"),"mozNotification").K9("createNotification",["See this","This is a notification"]).nQ("show")},"call$1",null,2,0,null,10,"call"],
$isEH:true},
Un:{
"^":"Tp:132;",
call$1:[function(a){var z=$.LX()
if(!J.UQ(z,"Notification").Bm("permission"))J.qQ(J.UQ(z,"Notification"),"permission",a)},"call$1",null,2,0,null,160,"call"],
$isEH:true},
waE:{
"^":"Tp:132;",
call$1:[function(a){if(J.UQ($.LX(),"screen").K9("mozLockOrientation",["portrait"])!=null)window.alert("Orientation locked to potrait")},"call$1",null,2,0,null,10,"call"],
$isEH:true},
Ore:{
"^":"Tp:132;",
call$1:[function(a){J.UQ($.LX(),"navigator").K9("vibrate",[2000])},"call$1",null,2,0,null,10,"call"],
$isEH:true},
YLa:{
"^":"Tp:132;",
call$1:[function(a){var z,y,x,w,v
...
J.UQ(J.UQ($.LX(),"navigator"),"geolocation").K9("getCurrentPosition",[new S.Zb(z),new S.oa(z)])},"call$1",null,2,0,null,10,"call"],
$isEH:true},
Zb:{
"^":"Tp:132;f",
call$1:[function(a){var z,y
...
J.oH(z.style,"block")
J.qQ($.LX(),"ondevicelight",new S.VWl(z))},"call$1",null,2,0,null,10,"call"],
$isEH:true},
VWl:{
"^":"Tp:132;bK",
call$1:[function(a){J.Qy(this.bK,"<strong>Ambient light: </strong> "+H.d(J.UQ(a,"value"))+" lux")},"call$1",null,2,0,null,162,"call"],
$isEH:true},
e1:{
"^":"Tp:132;",
call$1:[function(a){J.oH(document.querySelector("#proximity-display").style,"block")
J.qQ($.LX(),"ondeviceproximity",new S.oZ2())},"call$1",null,2,0,null,10,"call"],
$isEH:true},
oZ2:{
"^":"Tp:132;",
...
J.qQ($.LX(),"onuserproximity",new S.y88(z))},"call$1",null,2,0,null,10,"call"],
$isEH:true},
y88:{
"^":"Tp:132;Gq",
...
J.qQ($.LX(),"ondeviceorientation",new S.HiS(z))},"call$1",null,2,0,null,10,"call"],
$isEH:true},
HiS:{
"^":"Tp:132;Rm",
call$1:[function(a){var z,y,x
...
J.oH(z.style,"block")
y=C.p0.aM(document)
H.VM(new W.xC(0,y.uv,y.Ph,W.VF(new S.BTP(z)),y.Sg),[H.Kp(y,0)]).Zz()},"call$1",null,2,0,null,10,"call"],
$isEH:true},
BTP:{
"^":"Tp:132;w3",
...
y=P.uw(J.UQ($.LX(),"XMLHttpRequest"),[P.jT(H.B7(["mozSystem",!0],P.L5(null,null,null,null,null)))])
...
y=J.UQ(J.UQ($.LX(),"navigator"),"mozContacts").K9("getAll",[P.jT(H.B7([],P.L5(null,null,null,null,null)))])
J.oH(z.style,"block")
x=J.w1(y)
x.u(y,"onsuccess",new S.Zba(z,y))
x.u(y,"onerror",new S.oaa(z))},"call$1",null,2,0,null,10,"call"],
$isEH:true},
Zba:{
"^":"Tp:132;r,Zm",
call$1:[function(a){var z,y,x
...
oaa:{
"^":"Tp:136;Pz",
call$0:[function(){J.IR(this.Pz,"beforeend","Error")},"call$0",null,0,0,null,"call"],
$isEH:true},
e8:{
"^":"Tp:132;a,Of",
call$1:[function(a){var z,y,x
...
if($desc instanceof Array)$desc=$desc[1]
oaa.prototype=$desc
function e8(a,Of){this.a=a
this.Of=Of}e8.builtin$cls="e8"
if(!"name" in e8)e8.name="e8"
$desc=$collectedClasses.e8
if($desc instanceof Array)$desc=$desc[1]
e8.prototype=$desc
return[qE,Gh,rK,zS,fY,Mr,lJ,P2,nB,i3,it,Az,QP,IF,n6,Ny,Y5,Gc,nx,QQ,fW,y4,d7,Um,oJ,He,mN,vH,xO,Em,NW,rV,Wy,QF,Ec,cm,Nh,ae,cv,Fs,hY,ea,D0,as,hH,Aa,u5,Yu,iG,jP,Ax,xf,Vb,ST,tb,Sg,pA,Mi,HL,Xb,wP,eP,A6,Og,u8,M6,El,mC,SV,aB,fJ,Ih,Vh,rC,ZY,cx,Ee,Qb,PG,xe,Hw,bn,Ik,xI,Aj,Q0,eY,KV,BH,KY,G7,b1,Ql,wL,bP,mX,SN,HD,ni,rR,qj,nC,KR,ew,fs,u2,bX,UL,MC,Mx,qI,Ea,lp,kd,I0,yN,Cp,ua,HN,Ul,KK,ii,fq,h4,qk,GI,Tb,Iv,WP,yY,yJ,FB,xV,FH,y6,RH,Kn,Z2,w6,BR,vw,aG,J6,u9,Xg,UM,hq,NL,yp,Eh,Mq,Nf,Nc,rj,rh,Zv,Q7,hF,yK,Dh,ZJ,mU,ph,IT,JY,nV,ui,D6,DQ,Sm,xL,QU,es,jw,lv,pf,NV,Tx,HC,kK,TC,ih,Nd,zp,Xu,lu,tk,me,oB,Ah,EI,MI,Ub,bM,eW,um,ju,OE,N9,BA,d0,tp,rE,CC,PQ,uz,Yd,p8,AD,Gr,cs,GH,To,jr,j2,Pu,rQ,Lx,d5,hy,r8,aS,CG,Kf,MT,Rk,Eo,Pe,o4,ZD,vt,cu,BD,vR,Ja,zI,cB,LQ,yR,HP,fa,bi,Et,np,Pi,qO,xt,tG,P0,xl,Xr,Sl,Jo,Qm,D8,ET,df,zU,K8,xj,dE,Zc,dT,Pq,eE,V6,FK,Gv,kn,YE,Ue,iC,is,Q,P,im,VA,O,PK,JO,O2,aX,oU,cC,RA,IY,JH,jl,vK,Iy,JM,Ua,ns,yo,Bj,NO,II,fP,X1,HU,oo,OW,Tf,iY,yH,FA,Av,ku,LI,FD,Nv,Cj,Gi,Zr,W0,az,vV,Am,XO,dr,TL,KX,uZ,OQ,Tp,Bp,v,GS,lb,tD,hJ,dC,wN,VX,aL,a7,i1,xy,MH,A8,U5,SO,SU,GD,Ca,vs,da,pV,U7,rq,RW,YP,jZ,FZ,OM,qh,lz,Rl,Jb,M4,B5,PI,MO,nP,KA,Vo,qB,fI,LV,DS,dp,B3,CR,Qk,dR,uR,YR,fB,t3,fZ,TF,K5,Cg,Hs,pK,eM,R8,k6,oi,PL,fG,EQ,YB,a1,db,i5,N6,jg,YO,oz,b6,tj,zQ,u3,mW,ar,lD,LG,Sw,o0,Y2,CL,fR,iP,a6,P7,DW,Ge,LK,AT,bJ,mp,ub,ds,lj,UV,TO,VS,t7,HG,eV,qo,EH,An,c8,a,mE,Rn,wv,BV,id,l4,wi,zL,ec,dx,x5,tJ,i7,I2,RO,eu,xC,kG,JQ,Pb,vD,mD,Eg,m6,ct,tE,Ow,W9,rB,kF,mk,MM,fm,IU,l9,Gn,r7,Tz,Wk,DV,Hp,Nz,Jd,QS,b0,Dg,Ob,GV,Pg,fj,Ip,em,Lb,QA,VW,oZ,Cv,y8,Hi,ed,BT,PY,wa,Or,YL,wf,Oa,kJ,emv,Lbd,QAa,CvS,edy,Un,waE,Ore,YLa,wfa,Oaa,Zb,oa,e0,VWl,e1,oZ2,e2,y88,e3,HiS,e4,BTP,e5,PYo,u8k,e6,kJb,Una,e7,Zba,oaa,e8]}